  ...
  return (
    <div className="right-[60px] hidden sm:right-[64px] md:right-[68px] lg:right-[72px] xl:right-[76px] 2xl:right-[80px] top-[25%] absolute">
      <FontAwesomeIcon 
        ...
        className="texl-2xl hover:bg-gray-200 p-3 xl:p-4 rounded-full cursor-pointer bg-white dark:bg-gray-950 text-gray-900 dark:text-white dark:hover:bg-gray-800 transition-all duration-[10ms]"
      />
    </div>
  );
};
