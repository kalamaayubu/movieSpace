    ...
    if (showHistory) {
        return (
            <div className="z-40 fixed top-0 bottom-0 left-0 right-0 bg-black opacity-95 transition-all duration-[800ms]">
                ...
                <div 
                    className={`bg-white absolute top-[10%] bottom-[10%] left-[10%] z-50 rounded-sm transition-all duration-[800ms] opacity-100 overflow-y-scroll
                    ${showHistory ? 'w-[80%]' : 'w-[0%] h-[0%]'}`}
                >
                    <h1 className="text-center font-semibold text-2xl pt-2 pb-4 underline bg-white z-50 fixed w-[80%] shadow-md">History</h1>
                    <ul className="flex flex-col justify-center w-full gap-[1px] pt-5 mt-10">
                        <li className="w-full flex justify-between align-center px-3 py-2 transition-all duration-[400ms] odd:bg-red-50 even:bg-red-100 hover:odd:bg-red-100 hover:even:bg-red-200 cursor-default group">
